...
class SplitersAdmin(LeafletGeoAdmin):
    list_display = ('spliter_na', 'spliter_ty', 'no_of_port', 'used_ports', 'unused_por', 'installati', 'condition', 'slug', 'history', 'splicing_det', 'latitude', 'longitude', 'photo_name', 'photo_url')
